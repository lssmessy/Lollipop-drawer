...
public class TV implements Parcelable{
    ...
    public TV(long id, String title, String urlthumbNail, Date releaseDate, long votes, String overview){
        this.id=id;
        this.title=title;
    ...
    public static final Creator<TV> CREATOR
            = new Creator<TV>() {
